...
function WheelPicker<T extends WheelPickerValue = string>({
  ...
  return (
    <WheelPickerPrimitive.WheelPicker
      classNames={{
        optionItem: cn(
          "text-black data-disabled:opacity-40 dark:text-black text-lg font-semibold",
          classNames?.optionItem
        ),
        highlightWrapper: cn(
          "bg-blue-50 text-black dark:bg-blue-900/30 dark:text-black",
          "data-rwp-focused:ring-2 data-rwp-focused:ring-blue-300 data-rwp-focused:ring-inset dark:data-rwp-focused:ring-blue-600",
          classNames?.highlightWrapper
        ),
        highlightItem: cn(
          "text-lg font-semibold text-black data-disabled:opacity-40",
